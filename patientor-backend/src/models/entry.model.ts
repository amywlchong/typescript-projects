...
export const HospitalEntry = EntryModel.discriminator(
  EntryType.Hospital,
  HospitalEntrySchema
);
export const OccupationalHealthcareEntry = EntryModel.discriminator(
  EntryType.OccupationalHealthcare,
  OccupationalHealthcareEntrySchema
);
export const HealthCheckEntry = EntryModel.discriminator(
